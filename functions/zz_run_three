...
def zz_run_three():
    ...
    # gyro_straight(degrees=1500, start_power=90, end_power=60, easing=ExponentialEaseInOut)
    # wait_for_seconds(1)
    ...
    # wait_for_seconds(1)
    # #keep on going
    # gyro_straight(degrees= 80, start_power=40, end_power=40)
    # wait_for_seconds(1)
    ...
    # wait_for_seconds(1)
    # gyro_straight(degrees=-360, start_power=40, end_power=40, kp=2)

    # topIf=see_black_right)
    for i in range(2):
